...
class PCQM4Mv2(InMemoryDataset):
    def __init__(self, root='dataset', smiles2graph=smi2hgraph, transform=None, pre_transform=None, delocalization = None):
        '''
    ...
    def process(self):
        ...
        for i in tqdm(range(len(smiles_list))):
            ...
            atom_fvs, n_idx, e_idx, bond_fvs = self.smiles2graph(smiles, delocalization = self.delocalization)
